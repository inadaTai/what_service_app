...
RSpec.describe Micropost, type: :model do
  ...
  describe "記事の投稿テスト" do
    ...
    it "5MBを超える画像は添付することできない" do
      micropost.picture.attach(io: File.open(Rails.root.join('db', 'images_seeds', '6mb.jpg')), filename: '6mb.jpg',
                               content_type: 'image/jpg')
      expect(micropost).to be_invalid
    end

    it "記事に対し指定された拡張子以外の画像はあげることが出来ない" do
      micropost.picture.attach(io: File.open(Rails.root.join('db', 'images_seeds', 'iphone.gif')), filename: 'iphone.gif',
