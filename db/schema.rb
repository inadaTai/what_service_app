...
ActiveRecord::Schema.define(version: 2020_05_31_030023) do
  ...
  create_table "favorite_relationships", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.integer "user_id"
